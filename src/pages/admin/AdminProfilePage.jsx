...
export const AdminProfilePage = () => {
  ...
  return (
    <AdminLayout>
      <PageHeader
        title="Admin Profile"
        description="Campus Dean profile and academic authority credentials."
        breadcrumbs={[{ label: 'Dean Profile' }]}
      />
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="space-y-1">
                ...
                <Badge variant="navy" size="sm" className="!bg-slate-900 !text-amber-400 font-extrabold">
                  Campus Dean (Highest Academic Authority)
                </Badge>
