...
export const IBBlock = () => {
  ...
  const floors = [
    {
      ...
      name: 'Ground Floor',
      rooms: [
        { code: 'IB101', name: 'Software Engineering Lecture Hall', capacity: 60, status: 'Free' },
        { code: 'IB102', name: 'Computer Networks Lab', capacity: 45, status: 'Occupied' },
        { code: 'IB103', name: 'HOD & Department Office', capacity: 15, status: 'Open' }
      ]
    },
    {
      level: 2,
      name: 'First Floor',
      rooms: [
        { code: 'IB201', name: 'Cloud Computing Lab', capacity: 50, status: 'Free' },
        { code: 'IB202', name: 'Web Development Studio', capacity: 45, status: 'Occupied' },
        { code: 'IB203', name: 'Cyber Security Research Wing', capacity: 30, status: 'Open' }
      ]
    },
    {
      level: 3,
      name: 'Second Floor',
      rooms: [
        { code: 'IB301', name: 'Artificial Intelligence Seminar Room', capacity: 80, status: 'Free' },
        { code: 'IB302', name: 'Machine Learning Lab', capacity: 50, status: 'Occupied' },
        { code: 'IB303', name: 'Data Science Lab (Room CS302 / IB303)', capacity: 60, status: 'Class Active' }
      ]
    }
  ];
  ...
  return (
    <AppLayout>
      <PageHeader
        title="IB Block — Indoor Navigation"
        description="Interactive 3D indoor floor plans, classroom search, and real-time room navigation for Information Technology Block."
        breadcrumbs={[
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="relative bg-slate-900 text-white rounded-2xl p-6 min-h-[280px] border border-slate-800 flex flex-col justify-between overflow-hidden">
              ...
              <div className="relative z-10 flex items-center justify-between text-xs text-slate-400 border-b border-slate-800 pb-3">
                <span className="flex items-center gap-1.5"><Compass className="w-4 h-4 text-blue-400" /> Entrance / Elevator Wing</span>
                ...
                <div className="relative z-10 bg-blue-950/80 border border-blue-800 p-4 rounded-xl flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-semibold text-white">Turn right from Stairwell 2 ➔ Walk 15 meters down corridor.</p>
                    </div>
                  </div>
